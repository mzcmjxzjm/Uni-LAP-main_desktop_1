...
if __name__ == "__main__":
    ...
    tokenizer = AutoTokenizer.from_pretrained('./models/bert-base-uncased-echr')

    # Use as a stand-alone encoder
    bert = AutoModel.from_pretrained('./models/bert-base-uncased-echr')
    ...
    # Init Classifier
    model = AutoModelForSequenceClassification.from_pretrained('./models/bert-base-uncased-echr', num_labels=10)
